...
<main out:fade on:outroend={() => doneTransition = true} in:fade="{{delay: 500}}" class="flex-1 p-20 align-middle">
...
<main out:fade on:outroend={() => doneTransition = true} in:fade="{{delay: 500}}" class="flex-1 p-20 align-middle">
	...
	<h1 class="font-display text-3xl lg:text-5xl"> Where I've been </h1>
</main>
